...
function Pessoa() {
  ...
  async function Load() {
    ...
    const result = await axios.get("http://node-api-x2rq.onrender.com/pessoa");
  ...
  async function save(event) {
    ...
    try {
      await axios.post("http://node-api-x2rq.onrender.com/pessoa", {
        nome: nome,
        cpf: cpf,
        data: data,
  ...
  async function DeletePessoa(_id) {
    try {
      await axios.delete("http://node-api-x2rq.onrender.com/pessoa" + _id).then(function (response){
        alertV(response.data.message);
      });
  ...
  async function update(event) {
    ...
    try {
      await axios.patch(
        "http://node-api-x2rq.onrender.com/pessoa" +
